...
const LoadingSkeleton = () => (
  <div className="flex flex-col gap-2.5 p-4 animate-pulse">
    <div className="grid grid-cols-4 gap-2">
      {[1, 2, 3, 4].map((i) => (
        <div key={i} className="border border-border rounded-lg px-3 py-2.5 bg-white">
...
export default function AssessorCard({ data, isLoading }: AssessorCardProps) {
    ...
    <><div className="bg-white border border-border rounded-xl overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="text-[13px] font-bold text-text">Assessor Page</div>
        ...
        <div className="flex flex-col gap-2.5 p-4">
          <div className="grid grid-cols-4 gap-2">
            {[
              ...
              <div key={label} className="border border-border rounded-lg px-3 py-2.5 bg-white">
                <div className="text-[9px] font-bold text-text-muted uppercase tracking-[0.07em] mb-0.5">{label}</div>
                <div className="text-[11px] font-semibold text-text whitespace-pre-wrap leading-[1.4]">{val || "—"}</div>
              </div>
            ))}
          </div>
