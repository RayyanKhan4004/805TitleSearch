...
export const CATX_CODES: CatxCode[] = [
  {
    ...
    verbiage: "Property taxes, which are a lien not yet due and payable, including any assessments collected with taxes, to be levied for the fiscal year * – * which are a lien not yet payable.",
  },
  {
    code: "CATX 2",
    label: "General & Special Taxes (Unpaid)",
    verbiage: "General and Special City and/or County taxes, including any personal property taxes and any assessments collected with taxes, for the fiscal year * - *:\n1st Installment: $ *   Open Penalty: $ * (if unpaid by December 10)\n2nd Installment: $ *   Open Penalty: $ * (if unpaid by April 10)\nLand Value: $ *   Improvement Value: $ *   APN: *",
  },
  {
    code: "CATX 4",
    label: "Taxes Paid — Proration Detail",
    verbiage: "Property taxes for the fiscal year shown below are paid. For proration purposes the amounts are:\nFiscal year: *   APN: *\n1st Installment: *   2nd Installment: *\nExemption: *   Land: *   Improvements: *\nPersonal Property: *   Code Area: *   Assessment No: *",
  },
  {
    code: "CATX 5",
    label: "Supplemental Taxes",
    verbiage: "The lien of supplemental taxes, if any, assessed pursuant to the provisions of Chapter 3.5 (Commencing with Section 75) of the Revenue and Taxation Code of the State of California.",
  },
  {
    code: "CATX 6",
    label: "Improvement District Assessment",
    verbiage: "An assessment by the improvement district shown below:\nBond/Act No: *   Series/District: *   For: *\nSaid assessment is collected with the county/city property taxes.",
  },
  {
    code: "CATX 22",
    label: "Supplemental / Escaped Assessments",
    verbiage: "The lien of supplemental or escaped assessments of property taxes, if any, made pursuant to the provisions of Chapter 3.5 (commencing with Section 75) or Part 2, Chapter 3, Articles 3 and 4, respectively, of the Revenue and Taxation code of the State of California as a result of the transfer of title to the vestee named in Schedule A; or as a result of changes in ownership or new construction occurring prior to date of policy.",
  },
  {
    code: "CATX 30",
    label: "Tax Defaulted Property",
    verbiage: "Said property has been declared tax defaulted for non-payment of delinquent taxes for the fiscal year 20 * - 20 *.\nAmount to redeem for the above stated fiscal year (and subsequent years, if any):\nAmount: $*   Prior to: *\nAmount: $*   Prior to: *\nAssessors Parcel No.: *",
  },
  {
    code: "CATX 31",
    label: "Taxes Not Shown as Existing Liens",
    verbiage: "Taxes or assessments which are not shown as existing liens by the records of any taxing authority that levies taxes or assessments on real property or by the Public Records. Proceedings by a public agency which may result in taxes or assessments, or notices of such proceedings, whether or not shown by the records of such agency or by the Public Records.",
  },
];
