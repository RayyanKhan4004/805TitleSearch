                ...
                >
                  ...
                  <div className="rounded-lg overflow-hidden">
                    <button
                      onClick={() =>
                        setExpandedSection(
                          expandedSection === "status" ? null : "status",
                        )
                      }
                      ...
                      style={{
                        color: statusFilter.length > 0 ? "#8B0000" : "#334155",
                        background:
                    ...
                    >
                      ...
                      >
                        {statusFilter.length > 0 && (
                          <span
                            className="text-[10px] font-bold text-white px-1.5 py-0.25 rounded-full"
                  ...
                  <div className="rounded-lg overflow-hidden">
                    <button
                      ...
                      className="flex items-center justify-between w-full px-3 py-2 text-[12px] font-semibold text-left cursor-pointer border-none rounded-lg transition-all"
                      style={{
                        color: countryFilter.length > 0 ? "#8B0000" : "#334155",
                        background:
                  ...
                  <label
                    ...
                    style={{
                      color: rushFilter ? "#8B0000" : "#334155",
                      background: rushFilter ? "#fff5f5" : "transparent",
                    }}
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.background = "#f8fafc")
                    }
        ...
        >
          ...
          >
            <span>
              ...
              to{" "}
              <strong>{Math.min(safePage * pageSize, filtered.length)}</strong>{" "}
